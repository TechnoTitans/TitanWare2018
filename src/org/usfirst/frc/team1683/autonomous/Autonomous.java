...
public abstract class Autonomous {
	...
	public static enum State {
		INIT_CASE, END_CASE, WAIT, DRIVE_FORWARD, RUN_PATH, LIFT_ELEVATOR, RELEASE_CUBE, BACKUP, RUN_SINGLE_TARGET, 
		LIFT_ELEVATOR_2, LOWER_ELEVATOR, GRAB_CUBE, RELEASE_CUBE_2, DROP_GRABBER_2, DROP_GRABBER_1, WAIT_GRABBER, LIFT_ALITTLE, DRIVE_FORWARD_2, DRIVE_FORWARD_3, DRIVE_BACKWARD, RUN_PATH_2, GRAB_CUBE_2, DRIVENDROP;
	}
